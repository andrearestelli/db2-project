...
CREATE TABLE `opt_product_schedule_link` (
  ...
  `ID_opt_product` varchar(50) NOT NULL,
  PRIMARY KEY (`ID_user`,`ID_schedule`,`ID_opt_product`),
  KEY `id_opt_product_idx` (`ID_opt_product`),
  CONSTRAINT `id_opt_product_` FOREIGN KEY (`ID_opt_product`) REFERENCES `optional_product` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_user` FOREIGN KEY (`ID_user`, `ID_schedule`) REFERENCES `service_activation_schedule` (`user_id`, `ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `optional_product` VALUES ('Decoder',3,13),('Internet Tv channel',2,15),('SMS news feed',3,10);
...
CREATE TABLE `package_opt_product_link` (
  ...
  KEY `id_opt_product_idx` (`id_opt_product`),
  CONSTRAINT `ID_opt_product` FOREIGN KEY (`id_opt_product`) REFERENCES `optional_product` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ID_package_` FOREIGN KEY (`id_package`) REFERENCES `service_package` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `package_opt_product_link` VALUES (2,'Decoder'),(4,'Decoder'),(1,'Internet Tv channel'),(2,'SMS news feed');
...
-- Dump completed on 2021-12-03 14:50:08
